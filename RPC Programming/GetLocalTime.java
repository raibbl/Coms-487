...
class GetLocalTime {
    ...
    public static int execute(String ip, int port) {
        ...
        try {
            ...
            // set our values
            time.setValue(Integer.parseInt(bufferinfo[1]));
    ...
    // for testing
    /*
     * public static void main(String[] args) { int port =7000; //
     * if(args.length>1){ // port=Integer.parseInt(args[1]); // Scanner sc = new
     * Scanner(System.in); port = sc.nextInt();
     * 
     * valid.setValue("false"); System.out.println(valid.getsize()); execute(0,
     * port); System.out.println(valid.toString());
